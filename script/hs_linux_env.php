...
$cmd= "sudo mkdir -p ".HS_LIB.";sudo mkdir -p /usr/local/bin/;curl -L# https://raw.githubusercontent.com/poyu007/heisoo_env/master/build/hs_sync.phar  > ./hs_sync.phar;sudo mv ./hs_sync.phar $incFile;sudo chmod +x $incFile; ln -s ".HS_LIB."/hs_sync.phar /usr/local/bin/hs_sync;curl -S# http://get.sensiolabs.org/php-cs-fixer.phar > ./php-cs-fixer.phar;sudo chmod a+x ./php-cs-fixer.phar;sudo mv ./php-cs-fixer.phar ".HS_LIB.'/php-cs-fixer.phar';

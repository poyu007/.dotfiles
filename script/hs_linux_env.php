...
e($cmd,'run');
$cmd = "curl -L# http://get.sensiolabs.org/php-cs-fixer.phar > ./php-cs-fixer.phar;sudo chmod a+x ./php-cs-fixer.phar; sudo mv ./php-cs-fixer.phar ".HS_LIB."/php-cs-fixer.phar;";
e($cmd,'run');
# ln -s $dir/tmux.conf ~/.tmux.conf`;
